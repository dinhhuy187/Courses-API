...
namespace courses_buynsell_api.Migrations
{
    ...
    [Migration("20251220030640_IsBlock_for_conversation")]
    partial class IsBlock_for_conversation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("courses_buynsell_api.Entities.Block", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.PrimitiveCollection<int[]>("BlockedUserIds")
                        .IsRequired()
                        .HasColumnType("integer[]");
            ...
            modelBuilder.Entity("courses_buynsell_api.Entities.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("courses_buynsell_api.Entities.Course", b =>
                {
                    ...
                    b.Property<string>("CourseLecture")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("courses_buynsell_api.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("courses_buynsell_api.Entities.Message", b =>
                {
                    b.HasOne("courses_buynsell_api.Entities.Conversation", "Conversation")
                        .WithMany("Messages")
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("courses_buynsell_api.Entities.User", "Sender")
                        .WithMany()
